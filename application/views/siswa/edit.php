        ...
        <div class="card shadow-sm mb-4 border-bottom-primary">
            <div class="card-header bg-white py-3">
			 ...
			 <div class="card-body pb-2">
                ...
                <?= form_open('', [], ['id_siswa' => $user['id_siswa']]); ?>
            
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="username">NIK</label>
                    <div class="col-md-6">
                        <input value="<?= set_value('nik', $user['nik']); ?>"  type="text" id="nik" name="nik" class="form-control" placeholder="NIK">
				...
				<div class="row form-group">
                    ...
                    <div class="col-lg-5">
                        <div class="input-group">
                            <input  name="tanggal" id="tanggal" type="text" class="form-control datepicker" placeholder="yyyy-mm-dd" data-date-format="dd-mm-yyyy" value="<?php echo $user['tgl_lahir']; ?>" >
                        ...
                        <div class="input-group">
                            <select name="id_jenjang" id="id_jenjang" class="custom-select">
                                ...
                                <?php foreach ($jenjang as $b) : ?>
                                    <option <?= $user['id_jenjang'] == $b['id_jenjang'] ? 'selected' : '';  ?> <?= set_select('id_jenjang', $b['id_jenjang']) ?> value="<?= $b['id_jenjang'] ?>"><?= $b['nama_jenjang'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="input-group">
                            <select name="kelas_id" id="kelas_id" class="custom-select">
                                ...
                                <?php foreach ($kelas as $b) : ?>
                                    <option <?= $user['id_kelas'] == $b['id_kelas'] ? 'selected' : '';  ?> <?= set_select('kelas_id', $b['id_kelas']) ?> value="<?= $b['id_kelas'] ?>"><?= $b['nama_kelas'] ?></option>
                                <?php endforeach; ?>
                            </select>
