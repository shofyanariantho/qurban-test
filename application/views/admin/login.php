<!-- Outer Row -->
								...
								<div class="col-lg-6">
									<div class="p-5">
										<div class="text-center mb-3">
											<h1 class="h4 text-gray-900">Monitoring Qurban</h1>
										...
										<!--<div class="text-center mt-4">
											<a class="small text-info" href="<?= base_url('register') ?>">Buat Akun!</a>
										</div>-->
										<?= form_close(); ?>
									</div>
								</div>
			...
			<footer class="container-fluid">
				<p style="color:#fff;text-align: center;">&copy; 2020 Dysidea. All right reserved</p>
			 </footer>
