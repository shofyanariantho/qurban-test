...
<head>
    ...
    <title><?= $title; ?> | Informasi Raport Online</title>
                ...
                <nav class="navbar navbar-expand navbar-dark bg-info topbar mb-4 static-top shadow-sm">
					...
					<ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a href="<?= base_url() ?>" class="nav-link dropdown-toggle" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                
                                <img class="img-profile " src="<?= base_url() ?>assets/img/almatuq.png">
                                <span class="ml-2 mt-2 d-lg-inline text-white small text-capitalize">
                                     <h4>Informasi Raport Online</h4> </span>
                            </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                ...
                                <img class="img-profile rounded-circle" src="<?= base_url() ?>assets/img/avatar/<?= $user['foto']; ?>">
                               
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="<?= base_url('profilesiswa'); ?>">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Profile
                                </a>
                               
                                <a class="dropdown-item" href="<?= base_url('profilesiswa/ubahpassword'); ?>">
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; <script>document.write(new Date().getFullYear());</script> Informasi Raport Online   &bull; by <?= anchor('https://www.dysideatech.id', 'Dysidea'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
...
function popup() {
	Swal({
			"title": "Perhatian",
			"html":  "File Tidak bisa Dibuka!<br />Mohon selesaikan administrasi.",
			"type": "info"
		});
	}
</script>
