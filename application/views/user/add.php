				...
				<div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('role', 1); ?> value="1" type="radio" id="admin" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="admin">Admin</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('role', 2); ?> value="2" type="radio" id="user" name="role" class="custom-control-input">
